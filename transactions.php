...
<body class="flex flex-col h-screen">
    ...
    <nav class="bg-gray-800 flex-initial">
                    ...
                    <div class="hidden sm:block sm:ml-6">
                        <div class="flex space-x-4">
                            ...
                            <a href="./transactions.php"
                                class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium">Transactions</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="sm:hidden hidden" id="mobile-menu">
            <div class="px-2 pt-2 pb-3 space-y-1">
                ...
                <a href="./transactions.php"
                    class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium">Transactions</a>
            </div>
        </div>
    </nav>
    <!-- Navbar end -->
    ...
    <div class="flex-auto font-bold">
        <h1 class="text-4xl text-center my-2 underline" style="color: navy;">Transactions History</h1>
        <table class="border-collapse border-2 border-green-800 table-auto w-10/12 mx-auto text-center">
            <thead class="text-2xl bg-yellow-200" style="color: darkblue;">
                <tr>
                    <th class="w-1/9 border-2 border-green-800 ">Transaction ID</th>
                    <th class="w-1/3 border-2 border-green-800 ">Transferred From</th>
                    <th class="w-1/3 border-2 border-green-800 ">Transferred To</th>
                    <th class="w-2/9 border-2 border-green-800 ">Transferred Amount</th>
                </tr>
            </thead>
                ...
                if (mysqli_num_rows($result) > 0) {
                    while($row = mysqli_fetch_assoc($result)) {
                      ...
                      <tr>
                          ...
                          <td class="border-2 border-green-800">'.$row["transfer_from"].'</td>
                          <td class="border-2 border-green-800">'.$row["transfer_to"].'</td>
                          <td class="border-2 border-green-800">&#8377; '.$row["amount"].'.00</td>
                      </tr>
                      ';
                    }
                  } else {
